...
for i in range(numb-1):
    massiv_count.append(massiv[i-1] + massiv[i] + massiv[i+1])
massiv_count.append(massiv[-2] + massiv[-1] + massiv[0])
print(f"Максимальное количество собранных ягод: {max(massiv_count)}")